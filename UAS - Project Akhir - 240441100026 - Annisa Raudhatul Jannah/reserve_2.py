...
#         tanggal_baru = input(f"Tanggal ({reservasi['tanggal']}): ")
#         kode_jadwal_baru = input(f"Kode Jadwal ({reservasi['kode_jadwal']}): ").lower()

#         if tanggal_baru:
#             try:
#                 day, month, year = map(int, tanggal_baru.split("-"))
#                 reservasi['tanggal'] = tanggal_baru  
#             except ValueError:
#                 print("Format tanggal tidak valid! Harap gunakan format DD-MM-YYYY.")
#                 continue

#         if kode_jadwal_baru:
#             if kode_jadwal_baru in jadwal_kode:
#                 reservasi['kode_jadwal'] = kode_jadwal_baru
#             else:
#                 print("Kode jadwal tidak valid! Tidak ada perubahan pada jadwal.")
#                 continue
...
#         lanjut = input("\nApakah Anda ingin mengedit reservasi lainnya? (y/n): ").lower()
#         if lanjut != 'y':
#             break
...
def tambah_pelanggan():
    ...
    while True:
        ...
        # Validasi apakah usia adalah angka dan >= 16
